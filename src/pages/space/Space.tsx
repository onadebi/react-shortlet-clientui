...
const Space = () => {
  ...
  return (
    <div className="shortelContainer">
      {open && (
        <div className="slider">
          <FontAwesomeIcon icon={faCircleXmark} onClick={() => setOpen(false)} style={{cursor:'pointer'}} className='closeBtn'/>
          <FontAwesomeIcon icon={faCircleArrowLeft} className='arrow' onClick={()=> setSlideNumber(slideNumber === 0 ? (photos.length-1) : slideNumber -1)}/>
          <div className="sliderWrapper">
            <img src={photos[slideNumber].src} alt="" className="sliderImg" />
          </div>
          <FontAwesomeIcon icon={faCircleArrowRight}className='arrow' onClick={()=> setSlideNumber(slideNumber === (photos.length-1) ? 0 : slideNumber +1)} />
        </div>
      )}
      <div className="hotelWrapper">
        ...
        <div className="hotelAddress">
          ...
          <span>7 Mbadiwe road, Lagos</span>
        </div>
        ...
        <div className="hotelDetails">
          ...
          <div className="hotelDetailsPrice">
            ...
            <h2>
              <b>{`₦${Appsettings.functions.NumberCommaFormat(8450)}`}</b> (9
              nights)
            </h2>
